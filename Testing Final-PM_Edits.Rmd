...
data$Q95<-recode(data$Q95, "Less healthy than newborns in other households" = 1)
data$Q95<-recode(data$Q95, "About the same level of health as newborns in other households" = 2)
data$Q95<-recode(data$Q95, "AMore healthy than newborns in other households" = 3)
data$Q95b <- as.numeric(data$Q95)
