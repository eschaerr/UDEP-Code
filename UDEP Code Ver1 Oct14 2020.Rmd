...
UDEPHouseSurveyNov6 <- read_csv("UDEPHouseSurveyNov6.csv")
# names(data)
...
plot2 <- ggplot(data, aes(x = Q38, fill = Q38)) +
  ...
  scale_x_discrete(labels= c("More basic services than most households" = "More","About the same amount of basic services as most households" = "Same","Less basic services than most households" = "Less")) +
  labs(
...
Of the following nine computer skills, the average number that each household possesses is 
`r round(mean(data$Q122_sum),1)`. 
