...
t.hunger <- t.test(Q54b ~ designtype, data = joineddata)
text <- ifelse(t.hunger$p.value > 0.05,"However, the difference between the groups is not significant.",ifelse(t.hunger$estimate[1] > t.hunger$estimate[2], paste("A difference of means test indicates that significantly more respondents in the ", group1,"group worried about not having enough food."),paste("A difference of means test indicates that significantly more respondents in the ", group2, "group worried about not having enough food.")))

```
`r t.hunger$estimate[1]*100`% of participants in the `r group1` group worried about having enough food,whereas `r t.hunger$estimate[2]*100`% of participants in the `r group2` group worried about having enough food. `r text`
...
text <- ifelse(t.hunger$p.value > 0.05,"However, the difference between the groups is not significant.",ifelse(t.hunger$estimate[1] > t.hunger$estimate[2], paste("A difference of means test indicates that significantly more respondents in the ", group1,"group attained this level of education."),paste("A difference of means test indicates that significantly more respondents in the ", group2, "group attained this level of education.")))

plot
```

`r primary.ttest$estimate[1]*100`% of participants in the `r group1` received no education in the last 12 months,whereas `r hunger.ttest$estimate[2]*100`% of participants in the `r group2` received no education. `r text`

`r primary.ttest$estimate[1]*100`% of participants in the `r group1` received a primary education in the last 12 months,whereas `r hunger.ttest$estimate[2]*100`% of participants in the `r group2` received a primary education. `r text`

`r tech.ttest$estimate[1]*100`% of participants in the `r group1` received a technical education in the last 12 months,whereas `r tech.ttest$estimate[2]*100`% of participants in the `r group2` received a technical education. `r text`

`r tertiary.ttest$estimate[1]*100`% of participants in the `r group1` received a tertiary education in the last 12 months,whereas `r tertiary.ttest$estimate[2]*100`% of participants in the `r group2` received a tertiary education. `r text`
...
never.ttest <- t.test(never ~ designtype,data=extremes)
always.ttest <- t.test(always ~ designtype, data=extremes)
