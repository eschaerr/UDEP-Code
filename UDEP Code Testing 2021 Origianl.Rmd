...
gender_plot <- data %>%
  ...
  scale_fill_manual(values=c("navy", "sienna1")) +
...
age_plot <- data %>% 
  ...
  geom_histogram(show.legend=FALSE,fill="navy")+
...
disability_plot <- data %>%
  ...
  geom_bar(show.legend = FALSE) +
  scale_fill_manual(values=c("sienna1", "sienna1")) +
...
religion_plot1 <- data %>%
  ...
  geom_bar(show.legend = FALSE) +
  scale_fill_manual(values=c("navy", "navy")) +
...
religion_plot2 <- data %>%
  ...
  geom_bar(show.legend = FALSE, fill = "navy") +
...
plot2 <- ggplot(data, aes(x = Q28pd, fill=Q6b)) +
  ...
  ylab("Density") + xlab("Income ($ per day)") +
  scale_fill_manual(values=c("sienna1", "navy"),
                         name="Age Range",
                         breaks=c(0, 1),
                         labels=c("0-40", "40+"))
grid.arrange(plot1, plot2, ncol=2)
...
plot1 <- data %>%
  ...
  ggplot(aes(x = factor(Q34,levels=levels,ordered=TRUE))) +  geom_bar(show.legend = FALSE, fill ="navy" ) +
...
plot2 <- data %>%
  ...
  geom_bar(show.legend = FALSE, fill = "navy" ) +
#  scale_fill_manual(values = c("navy", "navy","navy","navy")) +
...
plot_edu128 <- data %>% 
  ...
  geom_bar(position = "dodge",fill="sienna1") +  
  theme(legend.position = c(0.8, 0.8)) +
  coord_flip() +
  scale_x_discrete(drop=FALSE) +
...
#  geom_histogram(binwidth = .5,show.legend=FALSE,fill="sienna1")+
...
plot_gndr_unpaid1 <- age_and_sex %>% 
  ...
  geom_col(position="dodge")+
  scale_fill_manual(values=c("navy", "grey85", "sienna1", "navy"),
                         name="")+
...
plot1 <- data %>%
  ...
  geom_bar(show.legend = FALSE, fill = "sienna1") +
...
#  scale_fill_manual(values=c("sienna1", "sienna1","sienna1", "sienna1","sienna1","sienna1","sienna1","sienna1","sienna1","sienna1")) +
#  coord_flip()
...
ggplot(aes(x = as.factor(Q48.1b), fill = as.factor(Q48.1b))) +
  ...
  scale_fill_manual(values = c("navy", "navy","navy", "navy","navy")) +
...
ggplot(aes(x = as.factor(Q43b), fill = as.factor(Q43b))) +
  ...
  scale_fill_manual(values=c("sienna1", "sienna1","sienna1", "sienna1","sienna1")) 
