...
plot1 <- data %>%
  filter(Q34b %in% levels) %>%
  filter(!Q34b == "") %>%
  ggplot(aes(x = factor(Q34b,levels=levels,ordered=TRUE))) +  geom_bar(show.legend = FALSE) +
  scale_fill_manual(values = c("#56B4E9", "#56B4E9","#56B4E9","#56B4E9")) +
  scale_x_discrete(labels= c("1" = "Worse","2" = "Same", "3" = "Better")) +
  labs(
...
levels <- c(1,2,3)
plot2 <- data %>%
  filter(Q38b %in% levels) %>%
  filter(!Q38b == "") %>%
  ggplot(aes(x = factor(Q38b,levels=levels,ordered=TRUE))) +  geom_bar(show.legend = FALSE) +
  geom_bar(show.legend = FALSE) +
  scale_fill_manual(values = c("#56B4E9", "#56B4E9","#56B4E9","#56B4E9")) +
  scale_x_discrete(labels= c("1" = "Fewer","2" = "Same","3" = "More")) +
  labs(
...
plot1 <- data %>%
  filter(Q87b %in% levels) %>%
  filter(!Q87b == "") %>%
  ggplot(aes(x = factor(Q87b,levels=levels,ordered=TRUE)))+
  geom_bar(show.legend = FALSE) +
  scale_fill_manual(values = c("#56B4E9", "#56B4E9","#56B4E9", "#56B4E9")) +
  scale_x_discrete(labels= c("1" = "Less","2" = "Same","3" = "More")) +
  labs(
...
plot2 <- data %>%
  filter(Q93b %in% levels) %>%
  filter(!Q93b == "") %>%
  ggplot(aes(x = factor(Q93b,levels=levels,ordered=TRUE)))+
  geom_bar(show.legend = FALSE) +
  scale_fill_manual(values = c("#56B4E9", "#56B4E9","#56B4E9", "#56B4E9")) +
  scale_x_discrete(labels= c("1" = "Better","2" = "Same","3" = "Less")) +
  labs(
...
plot_gndr88 <- data %>%
  filter(Q88b %in% levels) %>%
  filter(!Q88b == "") %>%
  ggplot(aes(x = factor(Q88b,levels=levels,ordered=TRUE)))+
  geom_bar(show.legend = FALSE) +
  scale_fill_manual(values = c("#56B4E9", "#56B4E9","#56B4E9", "#56B4E9")) +
  scale_x_discrete(labels= c("1" = "Less","2" = "Same","3" = "More")) +
  labs(
