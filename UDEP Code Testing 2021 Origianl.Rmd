...
gender_plot <- data %>%
  ...
  labs(
    title = "Count of Male and Female Respondents",
    x = "Count",
    y = ""
  )

# Bar Chart of Age -= want to change this to show a more appropriate distribution (histogram. not enough data yet)
age_plot <- data %>% 
  ggplot(aes(x=Q6))+
...
disability_plot <- data %>%
  ...
  labs(
    title = "Count of Respondents with a Disability",
    x = "Count",
    y = ""
  )
...
religion_plot2 <- data %>%
  ...
  geom_bar(show.legend = FALSE) +
  scale_fill_manual(values=c("#56B4E9", "#56B4E9","#56B4E9","#56B4E9","#56B4E9","#56B4E9","#56B4E9","#56B4E9")) +
  #scale_x_discrete(labels= c("0" = "No Religion","1" = "Religion")) + 
  labs(
    title = "Count of Respondents who Identify with a Religion",
    y = "Count",
