...
```{r}
data$Q46b <- ifelse(data$Q46 == "I don't have a place to call home.",1,ifelse(data$Q46 == "I have a home that is missing one or more walls/roof and has a dirt floor.",2,ifelse(data$Q46 == "I have a home that includes temporary walls/roof and has a dirt floor.  ",3,ifelse(data$Q46 == "I have a home with solid walls/roof and floor.",4,NA)))) # Ordinal measure for home quality
